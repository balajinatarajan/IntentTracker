var LegacyIntentTracker = (() => {
  ...
  // src/legacy-catalog.js
  function createLegacyCatalog(referenceMap = {}) {
    const items = /* @__PURE__ */ new Map();
    const selectorToMeta = /* @__PURE__ */ new Map();
    const selectorToId = /* @__PURE__ */ new Map();
  ...
  // ../lib/src/recommendation-engine.js
  ...
  `;
    ...
    function renderIntents() {
      if (intentLog.length === 0) {
        content.innerHTML = '<div class="__ik-empty">No intents detected yet...</div>';
        return;
      }
